...
export class ListComponent implements OnInit {
  ...
  public popoverMessage: string = 'You want to delete this subcategory';
  ...
  fetchData() {
    this._admin.getAllSubCategory()
    .subscribe(
      res => {
      	console.log(res)
        this.listItems = res.body.result.subcategory;
    ...
    deleteCategory(id){
	    console.log(id);
	    this._admin.deleteSubCategory(id).subscribe(
	      res=> {
	...
	changeStatus(id){
    console.log(id)
	    this._admin.changeSubCategoryStatus(id).subscribe(
	      res=>{
	        console.log(res)
